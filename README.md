...
Welcome to Quotes — your daily sanctuary of thoughtful inspiration. Each day, this app shares a carefully curated quote designed to remind you that you're not alone, even in quiet moments, and that every day carries a spark of hope. Explore messages crafted to uplift your spirit, nurture your motivation, and gently support your journey toward well-being.

## Live Website

View the live website here https://shezmoin.github.io/Quotes/

## Repository

View the repository here https://github.com/Shezmoin/Quotes.git
...
* Have a separate button to view all saved quotes on an additional page.
...
VSCode was used to write and create the website, using the inbuilt VSCode IDE.

### GitHub

Github was used to store the code within a repository and to host the site using GitHub Pages.

### Git

Git commands were used within the IDE to track version control.
