...
Additional testing was done by friends and family on a variety of devices and screen sizes. No issues were reported.
...
| New quote button responsive | The colour should become darker | Hover on the button | Button colour became darker | Pass |
...
| "Favorite this quote" button responsive | The button border should highlight | Hover on button | Image borders turns golden | Pass |
| Theme toggle button responsive | The button should show image of day or dark mode | Clicked on the button | The button image changes accordingly | Pass |
| Favorite button responsive | The button color should change one clicked | Clicked on button to add quote to favorite | Color changes when added or removed quote from favorite | Pass |
...
The website has been evaluated in multiple browsers, including Google Chrome, Brave, Firefox and Microsoft Edge, all of which were compatible with the site. The website was also tested on Google Chrome and Safari on mobile devices, also seeing no issues.
